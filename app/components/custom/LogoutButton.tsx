...
export default function LogoutButton() {
  return (
    <Button onClick={() => signOut({callbackUrl: '/'})} className="w-52 md:w-56 2xl:w-64 h-16 md:h-2 2xl:h-18 rounded-lg text-[1.15rem] md:text-[1rem] 2xl:text-[1.15rem] 3xl:text-[3.25rem] font-manrope font-normal bg-transparent text-black cursor-pointer transition-transform duration-300 ease-out hover:bg-transparent hover:scale-[1.04] group overflow-visible">
      logout of{" "}
